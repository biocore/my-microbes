...
function initializeGlossary() {
  ...
  var beta_diversity_html = "<div id='bdiv-definition' class='glossary-item' title='Beta Diversity'><p>Beta diversity measures between-sample diversity, which tells us the similarity or dissimilarity of a pair of samples. This information is most useful when you're comparing more than two samples, which is almost always the case, as beta diversity can then tell you about the relative similarity or dissimilarity between all pairs of your samples. For example, if you have human gut microbial communities from three individuals (say, individuals <i>A</i>, <i>B</i>, and <i>C</i>), and compute beta diversity for each pair of those three samples, your results may tell you that individual <i>A</i> is more similar to individual <i>B</i> than either is to individual <i>C</i>. Ecologists use many different metrics to measure beta diversity. The metric we use here is called UniFrac (see <a href='http://www.ncbi.nlm.nih.gov/pubmed/16332807' target='_blank'>Lozupone and Knight, 2005</a> for a discussion of UniFrac).</p></div>";
